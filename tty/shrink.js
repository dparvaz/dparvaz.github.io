class Shrink{
   constructor() {
      ...
      for (let i=0; i<this.theResponses.length; i++) {
   ...
   intro() {
	  return "hi this is eliza the virtual psychotherapist what would you like to discuss qq ga ";
   }
   ...
   reply(input) {
      ...
      response = response.replace(/ (with|to|of|for|at) i /g, " $1 me ");
